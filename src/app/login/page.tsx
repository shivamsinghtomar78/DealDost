...
export default function LoginPage() {
  ...
  const stats = [
    ...
    { icon: TrendingUp, value: "Rs 50L+", label: "Saved by Users" },
  ];
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#FF5722] via-[#FF6D3A] to-[#FF8A65]">
        <div className="absolute inset-0 opacity-10">
          {[...Array(20)].map((_, i) => (
            ...
            >
              {["deal", "food", "save", "city", "hot", "map", "live", "top"][
                i % 8
              ]}
            </motion.div>
          ))}
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16 text-white">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-3xl font-extrabold font-[family-name:var(--font-heading)]">
                DealDost
              </span>
            </div>
            ...
            <p className="text-xl text-white/80 mb-8">sab ek jagah</p>
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/10">
              <p className="text-sm italic text-white/90">
                &ldquo;Saved Rs 12,450 this month. DealDost is pure gold for
                budget shoppers.&rdquo;
              </p>
              <p className="text-xs text-white/60 mt-2">
                - @shivam_deals, Top Contributor
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white dark:bg-[#111318] px-6 py-12">
        ...
        >
          <div className="lg:hidden flex items-center gap-2 mb-8 justify-center">
            ...
            <span className="text-2xl font-extrabold text-[#FF5722] font-[family-name:var(--font-heading)]">
              DealDost
            </span>
          </div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2 mb-8">
            {mode === "login"
              ...
              : "India's #1 community for deals and food discovery"}
          </p>
